...
const Actions = ({ onDelete, onEdit, posts, equipes }: ActionsProps) => {
  ...
  return (
    <div>
      ...
      {showApagarPost && <ApagarPost posts={posts} showApagarPost={showApagarPost} closeShowApagarPost={() => setShowApagarPost(false)} />}
      {showEditarPost && <EditarPost posts={posts} equipes={equipes} showEditarPost={showEditarPost} closeShowEditarPost={() => setShowEditarPost(false)} />}
    </div>
  )
}
